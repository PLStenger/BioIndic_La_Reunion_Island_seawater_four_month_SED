...
# Note: max-depth should be chosen based on ConTable.qzv (or on /scratch_vol0/fungi/BioIndic_La_Reunion_Island_seawater_four_month_SED/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
