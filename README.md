...
First, open your terminal. Then, run these two command lines :
    ...
    git clone https://github.com/PLStenger/BioIndic_La_Reunion_Island_seawater_four_month_SED.git
...
### Run scripts in local by :
    ...
    cd /scratch_vol1/fungi/BioIndic_La_Reunion_Island_Lagoon/00_scripts
    ...
    time nohup bash 97_ORF_finder_TUFA.sh &> 97_ORF_finder_TUFA.out
